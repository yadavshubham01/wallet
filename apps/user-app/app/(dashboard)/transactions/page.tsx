...
const receiveTransactions :any =await getreceiveP2PTransactions()
    ...
    return (
     <div className="flex flex-col gap-5">
        ...
        <div className="w-[80vw] grid grid-cols-1 md:grid-cols-2 px-10 gap-3">
            ...
            <div>
                <OnRampTransactions title="Received transactions" transactions={receiveTransactions}/>
            </div>
        </div>
        ...
        <div className="w-[80vw] grid grid-cols-1 md:grid-cols-2 px-10 gap-3">
            ...
            <div>
                <OnRampTransactions title={"Successfull Transactions"} transactions={successTransactions}/>
            </div>
            <div>
                <OnRampTransactions title="Processing Transaction" transactions={processingTransactions}/>
            </div>
            <div>
